...
$( document ).ready( function( ){
	...
	function inicializarGeneros( generos ){
		...
		for( var i = 0 ; i < generos.length ; i++ ){
			...
			var option = $("<option>" , { text : zeroPad( genero.codigo , 6 ) + " " + genero.nombre , value : genero.codigo });
	...
	function cargarGeneros( ){
		getForObject( null , "/api/articulos/search/articulosgeneros" , inicializarGeneros , errorGeneros );
	}
