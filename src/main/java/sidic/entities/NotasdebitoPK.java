...
public class NotasdebitoPK implements Serializable {
    ...
    public NotasdebitoPK(double nrorecibocaja, double cliente, double factura, String usuario) {
    ...
    public String toString() {
        return "sidic.entities.NotasdebitoPK[ nrorecibocaja=" + nrorecibocaja + ", cliente=" + cliente + ", factura=" + factura + ", usuario=" + usuario + " ]";
    }
