...
public class Costodeventasjm1 implements Serializable {
    ...
    public Costodeventasjm1() {
    }

    public Costodeventasjm1(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Costodeventasjm1)) {
            return false;
        }
        Costodeventasjm1 other = (Costodeventasjm1) object;
    ...
    public String toString() {
        return "sidic.entities.Costodeventasjm1[ id=" + id + " ]";
    }
