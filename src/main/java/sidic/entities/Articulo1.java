...
public class Articulo1 implements Serializable {
    ...
    public Articulo1(Double codigo) {
        this.codigo = codigo;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Articulo1)) {
            return false;
        }
        Articulo1 other = (Articulo1) object;
    ...
    public String toString() {
        return "sidic.entities.Articulo1[ codigo=" + codigo + " ]";
    }
